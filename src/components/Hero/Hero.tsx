        ...
        <section className="bg-white py-20 mt-1">
            <div className="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Link href="/categories" className="bg-white text-black border-2 border-black px-8 py-3 rounded-md font-medium hover:bg-gray-500 transition-colors duration-200 min-w-35">
                        Browse Categories
                    </Link>
